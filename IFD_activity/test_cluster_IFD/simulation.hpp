...
struct ind {
    ...
    void mutate(bernoulli_distribution& mutate, normal_distribution<double>& mshape); //mutate function can be improves - number of mutations per gen can be calculated from a poission distrib and indiv randomly assigned mutation
...
// removed mutations for comp and boldness
  //  if (mrate(rnd::reng)) {
